...
// const phoneNumbers = data.map(user => {
//   return user.phone;
// });
// console.log(phoneNumbers);

// // create and print a list of website and email pairs (pair them in a string, array, or object)
// const siteAndEmail = data.map(user => [user.email, user.website]);
// console.log(siteAndEmail);
...
// // create a list of user 9's to-do's
// const user9Todo = otherData.filter(todo => todo.userId === 9);
...
// const user5Post = thirdData.filter(title => title.userId === 5);
...
const tasksSummary = tasks.reduce((acc, curr) => {
  if (acc[curr.userId === 3]) {
    acc[curr.userId === 3].totalTasks += 1;
    if (curr.completed === true) {
      acc[curr.userId === 3].complete += 1;
    } else {
      acc[curr.userId === 3].totalIncomplete += 1;
    }
  } else {
    acc[curr.userId === 3] = {
      totalTasks: 0,
    ...
    if (curr.completed === true) {
      ...
      acc[curr.userId === 3].incomplete += 1;
    }
  }
  return acc;
}, {});
